...
# Figure 5
Figure 5 uses simulations of individual trajectories to derive population level titre values. This can take a while; here we set the maximum number of draws to just 250 for speed.
Figure 5 A plots these across time; again, here we just replicate a portion of the figure for the Delta wave.

```{r}
result <- mod$simulate_individual_trajectories(n_draws = 250)
