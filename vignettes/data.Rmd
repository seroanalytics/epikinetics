...
that users who are already familiar with `cmdstanr` are free to do what they want with the fitted model. But three further functions
provide model outputs that we think are particularly useful in [data.table](https://cran.r-project.org/web/packages/data.table/) format.
